...
#
# Generated by Vivado on Sun Nov 03 16:58:16 EST 2019
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../mock_photon_signal.srcs/sources_1/ip/blk_mem_gen_0/sim/blk_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/feliks/Vivado/mock_photon_signal/mock_photon_signal.cache/compile_simlib/vcs"
  fi

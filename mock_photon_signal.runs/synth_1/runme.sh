...
HD_PWD='/home/feliks/Vivado/mock_photon_signal/mock_photon_signal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mock_photon_signal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mock_photon_signal.tcl

...
HD_PWD='/home/feliks/Vivado/mock_photon_signal/mock_photon_signal.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log mock_photon_signal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mock_photon_signal.tcl -notrace
